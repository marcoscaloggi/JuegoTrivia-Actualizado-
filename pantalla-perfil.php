          ...
          <li class="contenedor-foto">
            ...
            <div class="div-agregar-img oculto">
              <form class="" method="post" id=form-img enctype="multipart/form-data">
                ...
                <input name="foto" id="inputimg" type="file" style="display:none" </form> </div> </li> <li class="datos-usuario">
                <ul class="columna">
        ...
        <article class="article-partidas">
          ...
          <div class="contenedor-partidas">
            ...
            foreach ($partidas as $key => $partida) : ?>
              ...
              <a id=<?= $partida['id'] ?> <?php if ($partida["vidas"] > -1) {
                                              echo "href='pantalla-juego.php'";
                                            } ?> class="juego" style="background-color: <?= $partida['color'] ?>">
                <span class="estado-partida"><?php if ($partida["vidas"] < 0) {
                                                  echo "Finalizado";
                                                } else {
                                                  echo "En Curso";
                                                } ?></span>
                ...
                <div class="vidas">
                  <img src=<?php if ($partida['vidas'] < 1) {
                                echo "imagenes/corazon-gris.png";
                              } else {
                                echo "imagenes/corazon.png";
                              } ?> alt="" class="size-icon icon-vida">
                  <img src=<?php if ($partida['vidas'] < 2) {
                                echo "imagenes/corazon-gris.png";
                              } else {
                                echo "imagenes/corazon.png";
                              } ?> alt="" class="size-icon icon-vida">
                  <img src=<?php if ($partida['vidas'] < 3) {
                                echo "imagenes/corazon-gris.png";
                              } else {
                                echo "imagenes/corazon.png";
                              } ?> alt="" class="size-icon icon-vida">
